package net.tigereye.hellishmaterials.loot.condition;
...
import net.tigereye.hellishmaterials.registration.HMLootConditionTypes;
...
public class MatchKillerWeaponLootCondition implements LootCondition {
    ...
    public LootConditionType getType() {
        return HMLootConditionTypes.MATCH_KILLER_WEAPON;
    }
